...
local PANEL = {
	...
	UpdateColours = function( self, skin )
		self:SetTextColor(largeui_title)
	end,

	Paint = function( self, w, h )
        local halfW, h6 = w/2, h-6
        surface.SetDrawColor(largeui_desc)
        surface.DrawLine(halfW-20, h6, halfW+20, h6)
    end,
}
...
function PANEL:Paint( w, h )
    draw.BoxOutlined(0, 0, w, h, largeui_secondary, largeui_primary)
end
